...
import 'package:imgreat_phone_app/Classes/fullPhoto.dart';
...
class Chat extends StatelessWidget {
  ...
  Chat({Key key, this.peerId, this.peerAvatar, this.nickName})
      : super(key: key);
  ...
  Widget buildListMessage() {
    return Flexible(
      child: groupChatId == ''
          ? Center(
              child: CircularProgressIndicator(
                  valueColor: AlwaysStoppedAnimation<Color>(colorchat)))
          : StreamBuilder(
